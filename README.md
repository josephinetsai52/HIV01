...
This repository contains data, analytic code, and findings that support portions of the article, “[HIV Surveillance Annual Report, 2024](https://www.nyc.gov/assets/doh/downloads/pdf/dires/hiv-surveillance-annualreport-2024.pdf),” published December 2025, by the NYC Health Department. Please read that article, which contains important context and details, before proceeding.
...
- Annual HIV Surveillance Reports from the NYC Health Department
  ...
  The Tabula application was used to extract data from the surveillance pdf reports and convert the data into csv files. Raw data in csv or excel files were not available to the public from the NYC Health Department.

Each of the spreadsheets contain, among others, the following columns relevant to the analysis:

- `UHF NEIGHBORHOOD` — There are 42 United Heath Fund or UHF neighborhoods in NYC.  UHF neighborhoods were created by aggregating adjacent zip codes. UHF neighborhoods are used by the NYC Health Department to analyze health outcomes in local communities.
- `YEAR` — January 1/year to December 31/year
- 'HIV DIAGNOSES PER 100,000 POPULATION' - New HIV diagnoses during one year per 100,000 people in the specified borough or UHF neighborhood. Intercensal populations were calculated by the NYC Health Department.
- 'AGE-ADJUSTED DEATH RATE PER 1,000 PEOPLE WITH HIV' - Number of deaths during one year among 1,000 people with HIV in the specified borough or UHF neighborhood. Age adjustment was based on the 2010 United States population. Intercensal populations were calculated by the NYC Health Department.
